...
fit f(x) '1608-52_new.txt' using ($2*1.0E-18):5 via a,b,c
...
set label sprintf("SSE=%3.3f",FIT_WSSR) at 0.01,0.29
set label sprintf("a=%3.2f\261%3.2f",Small_a,Small_a_err) at 0.01,0.27
set label sprintf("H_0=%3.2f\261%3.2f km",H_0,H_0_err) at 0.01,0.25
set label sprintf("C=%3.2f\261%3.2f",amec,amec_err) at 0.01,0.23
fit g(x) '1608-52_new.txt' using ($2*1.0E-18):5 via m,n
set label sprintf("SSE=%3.3f",FIT_WSSR) tc rgb "blue" at 0.245,0.23
fit h(x) '1608-52_new.txt' using ($2*1.0E-18):5 via p,q
set label sprintf("SSE=%3.3f",FIT_WSSR) tc rgb "red" at 0.245,0.21
set label "{/Symbol Dn}=224Hz" at 0.25,0.31
set label "4U 1608-52" at 0.01,0.31


plot \
'1608-52_new.txt' using ($2*1.0E-18):5 pt 7 ps 2 notitle,\
...
fit f(x) '1636-54_new.txt' using ($2*1.0E-18):5 via a,b,c
...
set label sprintf("SSE=%3.2f",FIT_WSSR) at 0.01,0.56
set label sprintf("a=%3.2f\261%3.2f",Small_a,Small_a_err) at 0.01,0.52
set label sprintf("H_0=%3.2f\261%3.2f km",H_0,H_0_err) at 0.01,0.48
set label sprintf("C=%3.2f\261%3.2f",amec,amec_err) at 0.01,0.44

fit g(x) '1636-54_new.txt' using ($2*1.0E-18):5 via m,n
set label sprintf("SSE=%3.2f",FIT_WSSR) tc rgb "blue" at 0.48,0.36

fit h(x) '1636-54_new.txt' using ($2*1.0E-18):5 via p,q
set label sprintf("SSE=%3.2f",FIT_WSSR) tc rgb "red" at 0.48,0.32
set label "{/Symbol Dn}=217Hz" at 0.48,0.52
set label "4U 1636-53" at 0.01,0.6

plot \
'1636-54_new.txt' using ($2*1.0E-18):5 pt 7 ps 2 notitle,\
f(x) lt 1 lw 3 lc rgb "black" title 'phy',\
g(x) lt 2 lw 2 lc rgb "blue" title 'linear',\
h(x) lt 3 lw 2 lc rgb "red" title 'PL'
...
fit f(x) 'XTE J1701-462_new.txt' using ($2*1.0E-18):5 via a,b,c
...
set label sprintf("SSE=%3.5f",FIT_WSSR) at 0.6,0.56
set label sprintf("a=%3.2f\261%3.2f",Small_a,Small_a_err) at 0.6,0.52
set label sprintf("H_0=%3.2f\261%3.2f km",H_0,H_0_err) at 0.6,0.48
set label sprintf("C=%3.2f\261%3.2f",amec,amec_err) at 0.6,0.44

fit g(x) 'XTE J1701-462_new.txt' using ($2*1.0E-18):5 via m,n
set label sprintf("SSE=%3.5f",FIT_WSSR) at 0.12,0.4 tc rgb "blue"
fit h(x) 'XTE J1701-462_new.txt' using ($2*1.0E-18):5 via p,q
set label sprintf("SSE=%3.5f",FIT_WSSR) at 0.12,0.35 tc rgb "red"
set label "{/Symbol Dn}=232Hz" at 0.195,0.58

set label "XTE J1701-462" at 0.6,0.6

plot \
'XTE J1701-462_new.txt' using ($2*1.0E-18):5 pt 7 ps 2 notitle,\
f(x) lt 1 lw 3 lc rgb "black" title 'phy',\
g(x) lt 2 lw 2 lc rgb "blue" title 'linear',\
h(x) lt 3 lw 2 lc rgb "red" title 'PL'
