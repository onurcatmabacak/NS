...
real(8), dimension(5000) :: Mdot,Count_Rate,Flux,Luminosity,Delta_Nu,Lower_QPO,Upper_QPO_Frequency
real(8), dimension(5000) :: rin,Omega_rin,Omega_Kepler_rin,Constant,ABL,Fastness,Epsilon,Delta
real(8) :: Magnetic_Field,Alpha_BL,Mass,Radius,Nustar,Omega_Star,Distance,Kiloparsec,Parsec,pi,Mdot_Eddington
real(8) :: Gravitational_Constant,Mass_Solar,Mass_Star,Mdot_max,Mdot_min,Speed_of_Light,Magnetic_Moment,A_1,A_2,Epsilon_Cycle
real(8) :: Magnetic_Field_min,Magnetic_Field_max,Magnetic_Field_step,Magnetic_Field_min_Alfven,Magnetic_Field_min_ISCO
reaL(8) :: Radius_max,Radius_min,Hadronic_Constant,Conversion_Factor,NuCorona
character*100 :: frmt,x ! format descriptor
character*30 :: filename,SourceName(4)
        ...
        if(Magnetic_Field_max .gt. Magnetic_Field_min) then
          ...
          do while(Magnetic_Field .lt. Magnetic_Field_max)
            ...
            do i=1,Number_of_Lines
              ...
              if(Tip .eq. 1) then ! Kappa equals upper qpo- kappa and kappa-omega frequency bands 
                Constant(i)=(((2.0*pi*Upper_QPO_Frequency(i))**(2.0))/(2.0*Omega_rin(i)))-&
                (2.0*Omega_rin(i))+(1.5*Omega_Kepler_rin(i))
              else if(Tip .eq. 2) then ! Kappa equals lower qpo- kappa+omega and kappa frequency bands
            ...
            do i=1,Number_of_Lines
              ...
              if(Delta(i) .gt. 0.01 .and. Delta(i) .lt. 0.3) then 
                onur=onur+1
              end if            
            end do
...
character*20, dimension(8) :: Source_Name
...
write(16,130) i_write-499,Source_Name(i_read-7),Mass,Radius,Magnetic_Field,Alpha_BL,ChiSquare,z(1),abs(z(2)),-abs(z(3)),&
Small_a,H_0,C,maxval(Delta,(Delta .gt. 0.0))/Alpha_BL,minval(Delta,(Delta .gt. 0.0))/Alpha_BL,&
maxval(Delta,(Delta .gt. 0.0)),minval(Delta,(Delta .gt. 0.0))
i_write=i_write+1
!::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::!
end subroutine 
