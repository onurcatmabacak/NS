...
onur7, onder7, merve7 = filter(rnew7,mnew7)
onur8, onder8, merve8 = filter(rnew8,mnew8)
onur9, onder9, merve9 = filter(rnew9,mnew9)
onur10, onder10, merve10 = filter(rnew10,mnew10)
...
onur17, onder17, merve17 = filter(anew7,hnew7)
onur18, onder18, merve18 = filter(anew8,hnew8)
onur19, onder19, merve19 = filter(anew9,hnew9)
onur20, onder20, merve20 = filter(anew10,hnew10)
...
ax1.fill_between(onur7, onder7, merve7, color='b', alpha=alpha, label=r'$Aql\;X-1\;2.5\;kpc\;Barret$')
#ax1.fill_between(onur8, onder8, merve8, color='k', alpha=alpha, label=r'$Aql\;X-1\;5.2\;kpc\;Barret$')
ax1.fill_between(onur9, onder9, merve9, color='c', alpha=alpha, label=r'$Aql\;X-1\;2.5\;kpc\;Mendez$')
#ax1.fill_between(onur10, onder10, merve10, color='m', alpha=alpha, label=r'$Aql\;X-1\;5.2\;kpc\;Mendez$')
...
ax2.fill_between(onur17, onder17, merve17, color='b', alpha=alpha, label=r'$Aql\;X-1\;2.5\;kpc\;Barret$')
#ax2.fill_between(onur18, onder18, merve18, color='k', alpha=alpha, label=r'$Aql\;X-1\;5.2\;kpc\;Barret$')
ax2.fill_between(onur19, onder19, merve19, color='c', alpha=alpha, label=r'$Aql\;X-1\;2.5\;kpc\;Mendez$')
#ax2.fill_between(onur20, onder20, merve20, color='m', alpha=alpha, label=r'$Aql\;X-1\;5.2\;kpc\;Mendez$')

#ax2.fill_between([onur12, onder12, merve12], [onur14, onder14, merve14], color='k', alpha=1.0)
