...
real(8), dimension(10000000) :: Mass,Radius,Magnetic_Field,Alpha_BL,Delta_max,Delta_min,Chi_Square,A_1,A_2,A_3
real(8), dimension(10000000) :: Small_a,H_0,C,Eps_max,Eps_min
character*100 :: frmt,x ! format descriptor
character(len=30) :: filename,Source_Name(10000000)
character*30, dimension(10) :: SourceName
  ...
  open(15,file='Aql_X_1_2.5_kpc_Mendez.dat')
  open(16,file='Aql_X_1_5.2_kpc_Mendez.dat')
  open(17,file='Aql_X_1_2.5_kpc_Barret.dat')
  open(18,file='Aql_X_1_5.2_kpc_Barret.dat')
  ...
  'Eps_min','Deltamax','Deltamin'
  write(17,100) '#','Source_name','Mass','Radius','Mag. Field','Alpha_BL','Chi^2','A_1','A_2','A_3','a','H_0','C','Eps_max',&
  'Eps_min','Deltamax','Deltamin'
  write(18,100) '#','Source_name','Mass','Radius','Mag. Field','Alpha_BL','Chi^2','A_1','A_2','A_3','a','H_0','C','Eps_max',&
  'Eps_min','Deltamax','Deltamin'
  

  do Data_Read=140,140
    ...
    open(20,file=filename)
      ...
      do i=1,Number_of_Lines
        ...
        if(Source_Name(i) .eq. SourceName(1)) then
          ...
          A_1(i),A_2(i),A_3(i),Small_a(i),H_0(i),C(i),Eps_max(i),Eps_min(i),Delta_max(i),Delta_min(i)
        else if(Source_Name(i) .eq. SourceName(9)) then
          write(17,101) i_write(i),adjustr(Source_Name(i)),Mass(i),Radius(i),Magnetic_Field(i),Alpha_BL(i),Chi_Square(i),&
          A_1(i),A_2(i),A_3(i),Small_a(i),H_0(i),C(i),Eps_max(i),Eps_min(i),Delta_max(i),Delta_min(i)
        else if(Source_Name(i) .eq. SourceName(10)) then
          write(18,101) i_write(i),adjustr(Source_Name(i)),Mass(i),Radius(i),Magnetic_Field(i),Alpha_BL(i),Chi_Square(i),&
          A_1(i),A_2(i),A_3(i),Small_a(i),H_0(i),C(i),Eps_max(i),Eps_min(i),Delta_max(i),Delta_min(i)
        end if
      end do
